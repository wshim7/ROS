...
//---------------------------------------------------------
void XmlSettings::saveFile(const string& xmlFile){
...
//---------------------------------------------------------
void XmlSettings::clearTagContents(const string& tag, int which){
...
//---------------------------------------------------------
void XmlSettings::removeTag(const string& tag, int which){
...
//---------------------------------------------------------
bool XmlSettings::pushTag(const string&  tag, int which){
...
//---------------------------------------------------------
int XmlSettings::getPushLevel(){
	return level;
}

//---------------------------------------------------------
bool XmlSettings::tagExists(const string& tag, int which){
...
//---------------------------------------------------------
int XmlSettings::getNumTags(const string&  tag){
...
//---------------------------------------------------------
int XmlSettings::addValue(const string& tag, int value){
	char valueStr[255];
	sprintf(valueStr, "%i", value);
...
//---------------------------------------------------------
int XmlSettings::addValue(const string&  tag, double value){
	char valueStr[255];
	sprintf(valueStr, "%f", value);
	int tagID = writeTag(tag, valueStr, -1) -1;
	return tagID;
...
//---------------------------------------------------------
int XmlSettings::addValue(const string& tag, const string& value){
	int tagID = writeTag(tag, value, -1) -1;
	return tagID;
}

//---------------------------------------------------------
int XmlSettings::addTag(const string& tag){
...
//---------------------------------------------------------
int XmlSettings::addAttribute(const string& tag, const string& attribute, int value, int which){
	char valueStr[255];
	sprintf(valueStr, "%i", value);
...
//---------------------------------------------------------
int XmlSettings::addAttribute(const string& tag, const string& attribute, int value){
	return addAttribute(tag,attribute,value,-1);
}

//---------------------------------------------------------
int XmlSettings::addAttribute(const string& tag, const string& attribute, double value, int which){
	char valueStr[255];
...
//---------------------------------------------------------
int XmlSettings::addAttribute(const string& tag, const string& attribute, double value){
	return addAttribute(tag,attribute,value,-1);
}

//---------------------------------------------------------
int XmlSettings::addAttribute(const string& tag, const string& attribute, const string& value, int which){
	int tagID = writeAttribute(tag, attribute, value, which) -1;
	return tagID;
}

//---------------------------------------------------------
int XmlSettings::addAttribute(const string& tag, const string& attribute, const string& value){
	return addAttribute(tag,attribute,value,-1);
}

//---------------------------------------------------------
void XmlSettings::removeAttribute(const string& tag, const string& attribute, int which){
	vector<string> tokens = tokenize(tag,":");
	TiXmlHandle tagHandle = storedHandle;
	for (int x = 0; x < tokens.size(); x++) {
		if (x == 0)
...
//---------------------------------------------------------
void XmlSettings::clearTagAttributes(const string& tag, int which){
	vector<string> names;
...
//---------------------------------------------------------
int XmlSettings::getNumAttributes(const string& tag, int which){
	vector<string> tokens = tokenize(tag,":");
	TiXmlHandle tagHandle = storedHandle;
	for (int x = 0; x < tokens.size(); x++) {
		if (x == 0)
...
//---------------------------------------------------------
bool XmlSettings::attributeExists(const string& tag, const string& attribute, int which){
	vector<string> tokens = tokenize(tag,":");
	TiXmlHandle tagHandle = storedHandle;
	for (int x = 0; x < tokens.size(); x++) {
		if (x == 0)
...
//---------------------------------------------------------
bool XmlSettings::getAttributeNames(const string& tag, vector<string>& outNames, int which){
	vector<string> tokens = tokenize(tag,":");
	TiXmlHandle tagHandle = storedHandle;
	for (int x = 0; x < tokens.size(); x++) {
		if (x == 0)
...
//---------------------------------------------------------
int XmlSettings::getAttribute(const string& tag, const string& attribute, int defaultValue, int which){
...
//---------------------------------------------------------
double XmlSettings::getAttribute(const string& tag, const string& attribute, double defaultValue, int which){
...
//---------------------------------------------------------
string XmlSettings::getAttribute(const string& tag, const string& attribute, const string& defaultValue, int which){
...
//---------------------------------------------------------
int XmlSettings::setAttribute(const string& tag, const string& attribute, int value, int which){
	char valueStr[255];
	sprintf(valueStr, "%i", value);
	int tagID = writeAttribute(tag, attribute, valueStr, which) -1;
	return tagID;
...
//---------------------------------------------------------
int XmlSettings::setAttribute(const string& tag, const string& attribute, double value, int which){
	char valueStr[255];
	sprintf(valueStr, "%lf", value);
	int tagID = writeAttribute(tag, attribute, valueStr, which) -1;
	return tagID;
...
//---------------------------------------------------------
int XmlSettings::setAttribute(const string& tag, const string& attribute, const string& value, int which){
	int tagID = writeAttribute(tag, attribute, value, which) -1;
	return tagID;
}

//---------------------------------------------------------
TiXmlElement* XmlSettings::getElementForAttribute(const string& tag, int which){
	vector<string> tokens = tokenize(tag,":");
	TiXmlHandle tagHandle = storedHandle;
	for (int x = 0; x < tokens.size(); x++) {
		if (x == 0)
...
//---------------------------------------------------------
bool XmlSettings::readIntAttribute(const string& tag, const string& attribute, int& outValue, int which){
...
//---------------------------------------------------------
bool XmlSettings::readDoubleAttribute(const string& tag, const string& attribute, double& outValue, int which){
...
//---------------------------------------------------------
bool XmlSettings::readStringAttribute(const string& tag, const string& attribute, string& outValue, int which){
...
//---------------------------------------------------------
int XmlSettings::writeAttribute(const string& tag, const string& attribute, const string& valueString, int which){
	vector<string> tokens = tokenize(tag,":");
	TiXmlHandle tagHandle = storedHandle;
	for (int x = 0; x < tokens.size(); x++) {
		if (x == 0)
...
//---------------------------------------------------------
//void XmlSettings::loadFromBuffer( string buffer )
//{
//
...
//}
//---------------------------------------------------------
void XmlSettings::copyXmlToString(string & str)
{
